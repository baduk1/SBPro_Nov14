    ...
    <div className="py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        <motion.div
          ...
          className="absolute top-0 left-1/4 w-96 h-96 bg-blue-200 rounded-full opacity-20 blur-3xl"
        />
        <motion.div
          animate={{
            scale: [1.2, 1, 1.2],
          ...
          className="absolute bottom-0 right-1/4 w-96 h-96 bg-purple-200 rounded-full opacity-20 blur-3xl"
        />
      </div>
      ...
      <div className="max-w-4xl mx-auto relative">
        <motion.div
          ...
          viewport={{ once: true }}
          className="text-center bg-white rounded-3xl shadow-2xl p-8 lg:p-12 border border-slate-200"
        >
          <motion.div
            initial={{ scale: 0 }}
            whileInView={{ scale: 1 }}
          ...
          <p className="text-slate-600 mb-8 max-w-2xl mx-auto">
            Join over 50,000 construction professionals using SkyBuild Pro. 
