...
function GridOverlays() {
  ...
  if (showNoRowsOverlay) {
    overlay = (0, import_jsx_runtime19.jsx)(rootProps.slots.noRowsOverlay, _extends({}, rootProps.slotProps?.noRowsOverlay));
    overlayType = "noRowsOverlay";
  }
  if (showNoResultsOverlay) {
    overlay = (0, import_jsx_runtime19.jsx)(rootProps.slots.noResultsOverlay, _extends({}, rootProps.slotProps?.noResultsOverlay));
    overlayType = "noResultsOverlay";
  }
  if (loading) {
    overlay = (0, import_jsx_runtime19.jsx)(rootProps.slots.loadingOverlay, _extends({}, rootProps.slotProps?.loadingOverlay));
...
function GridColumnHeaderItem(props) {
  ...
  const columnTitleIconButtons = (0, import_jsx_runtime44.jsxs)(React62.Fragment, {
    ...
    }, rootProps.slotProps?.columnHeaderFilterIconButton)), showSortIcon && (0, import_jsx_runtime44.jsx)(GridColumnHeaderSortIcon, {
...
function GridColumnsManagement(props) {
  ...
  return (0, import_jsx_runtime55.jsxs)(React74.Fragment, {
    children: [(0, import_jsx_runtime55.jsx)(GridColumnsManagementHeader, {
      ...
      className: classes2.root,
      ownerState: rootProps,
      children: [currentColumns.map((column) => (0, import_jsx_runtime55.jsx)(FormControlLabel_default, {
      ...
      }, column.field)), currentColumns.length === 0 && (0, import_jsx_runtime55.jsx)(GridColumnsManagementEmptyText, {
        ownerState: rootProps,
...
function GridColumnsPanel(props) {
  ...
  return (0, import_jsx_runtime56.jsx)(GridPanelWrapper, _extends({}, props, {
    children: (0, import_jsx_runtime56.jsx)(GridColumnsManagement, _extends({}, rootProps.slotProps?.columnsManagement))
  }));
}
...
var GridFilterForm = React80.forwardRef(function GridFilterForm2(props, ref) {
  ...
  return (0, import_jsx_runtime61.jsxs)(GridFilterFormRoot, _extends({
    ...
    children: [(0, import_jsx_runtime61.jsx)(FilterFormDeleteIcon, _extends({
      ...
      ownerState: rootProps,
      children: currentOperator?.InputComponent ? (0, import_jsx_runtime61.jsx)(currentOperator.InputComponent, _extends({
        apiRef,
        item,
...
var GridFooter = React90.forwardRef(function GridFooter2(props, ref) {
  ...
  const rowCountElement = !rootProps.hideFooterRowCount && !rootProps.pagination ? (0, import_jsx_runtime71.jsx)(rootProps.slots.footerRowCount, _extends({}, rootProps.slotProps?.footerRowCount, {
    rowCount: totalTopLevelRowCount,
    visibleRowCount: visibleTopLevelRowCount
  })) : null;
  const paginationElement = rootProps.pagination && !rootProps.hideFooterPagination && rootProps.slots.pagination && (0, import_jsx_runtime71.jsx)(rootProps.slots.pagination, _extends({}, rootProps.slotProps?.pagination));
...
function GridHeader() {
  ...
  return (0, import_jsx_runtime73.jsxs)(React92.Fragment, {
    children: [(0, import_jsx_runtime73.jsx)(GridPreferencesPanel, {}), rootProps.slots.toolbar && (0, import_jsx_runtime73.jsx)(rootProps.slots.toolbar, _extends({}, rootProps.slotProps?.toolbar))]
  });
}
...
function useGridColumns(apiRef, props) {
  ...
  const preferencePanelPreProcessing = React114.useCallback((initialValue, value) => {
    if (value === GridPreferencePanelsValue.columns) {
      ...
      return (0, import_jsx_runtime81.jsx)(ColumnsPanel, _extends({}, props.slotProps?.columnsPanel));
    }
    return initialValue;
...
var useGridFilter = (apiRef, props) => {
  ...
  const preferencePanelPreProcessing = React119.useCallback((initialValue, value) => {
    if (value === GridPreferencePanelsValue.filters) {
      ...
      return (0, import_jsx_runtime84.jsx)(FilterPanel, _extends({}, props.slotProps?.filterPanel));
    }
    return initialValue;
