# 🚀 SkyBuild Pro - Deployment Instructions for Cursor/Claude Code
...
✅ Credits system atomic with refunds
...
# - app.yourdomain.com → your actual user domain
# - admin.yourdomain.com → your actual admin domain
# - https://api.yourdomain.com → your actual backend domain (in CSP header)
...
# Common issues:
# 1. SECRET_KEY not set → Check .env file
# 2. Database connection failed → Check DB_URL and PostgreSQL status
# 3. SMTP invalid → Check SendGrid credentials
