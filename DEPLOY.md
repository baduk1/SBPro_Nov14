...
This guide explains how to deploy the **SkyBuild Pro** MVP to a single Ubuntu server (e.g., Ubuntu 22.04), using **FastAPI** (Gunicorn + Uvicorn worker) and **Nginx** serving the React bundle and reverse‑proxying the API.
